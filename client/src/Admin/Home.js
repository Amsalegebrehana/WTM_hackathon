    ...
    <div className="container">
      <div className="row m-5">
        <div className="col-lg-3 col-6">
                <div className="small-box bg-info py-5">
            <div className="inner">
              <h3>150</h3>
              <p>Users</p>
            </div>
        ...
        <div className="col-lg-3 col-6">
                <div className="small-box bg-success py-5">
            <div className="inner">
              <h3>53<sup style={{fontSize: 20}}></sup></h3>
              <p>Healthcare Profesionals</p>
            </div>
            <div className="icon">
        ...
        <div className="col-lg-3 col-6">
                <div className="small-box bg-warning py-5">
            <div className="inner">
              <h3>44</h3>
                        ...
                        <Col md={4}>
                          <Card>
                            <Card.Body>
                              ...
                              <Card.Text>Name: {HPuser.name}</Card.Text>
                              <Card.Text>Phone: {HPuser.phone}</Card.Text>
                              <Card.Text>Email: {HPuser.email}</Card.Text>
                              <Card.Text>Date of Birth: {HPuser.dob}</Card.Text>
                            </Card.Body>
                          </Card>
                        </Col>
                        </Row>
